...
from datasets.h36m_iccv import  H36M
...
def demo_image(image, model, opt):
  ...
  pred_3d_h36m = []
  h36m = H36M(opt,'val')
  pred_3d_h36m_data =  h36m.convert_eval_format(pred_3d)
  pred_3d_h36m.append(pred_3d_h36m_data)
  debugger = Debugger()
...
def main(opt):
  ...
  if opt.load_model == '':
    opt.load_model = 'fusion_3d_var.pth'
  if opt.gpus[0] >= 0:
